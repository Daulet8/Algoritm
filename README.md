...
Очередь (Queue) — FIFO (первый пришёл → первый вышел)
Стек (Stack) — LIFO (последний пришёл → первый вышел)
2. Что означает FIFO?
...
банки и кассы 🏦
очереди в магазинах 🛒
обработка задач в компьютере 💻
печать документов (очередь принтера) 🖨️
